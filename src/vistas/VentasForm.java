...
public class VentasForm extends javax.swing.JInternalFrame {
    ...
    public VentasForm() {
        ...
        generarSerie();
        fecha();
        txtVendedor.setText("Luis Quispe");
    ...
    private void initComponents() {
        ...
        txtFecha.setFont(new java.awt.Font("Tahoma", 0, 3)); // NOI18N
        txtFecha.setForeground(new java.awt.Color(255, 255, 255));

        fecha_Ventas.setDateFormatString("yyyy-MM-dd");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(11, 11, 11))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(fecha_Ventas, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jLabel15))
                    .addComponent(fecha_Ventas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
...
//        ));
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("D:\\Descargas\\tabla.pdf"));
        ...
        // Abre el objeto Document
        document.open();
        
        // Crea una nueva tabla para el PDF
        PdfPTable pdfTable = new PdfPTable(table.getColumnCount());
        
        // Agrega las celdas a la tabla del PDF
        ...
        try {
            // Agrega la tabla al objeto Document
            document.add(pdfTable);
        } catch (DocumentException ex) {
            Logger.getLogger(VentasForm.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        // Cierra el objeto Document
        document.close();
    ...
    void guardarVenta() {
        Date date = fecha_Ventas.getDate();
        long d = date.getTime();
        java.sql.Date fecha1 = new java.sql.Date(d);
        SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
        String fechaString = formato.format(fecha1);
        int idv = 1;
